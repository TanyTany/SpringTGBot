...
public class CounterTelegramBot extends TelegramLongPollingBot implements BotCommands {
    ...
    //для Spring, что в это поле нужно инжектнуть бин
    @Autowired
    ...
    //метод добавления пользователя в базу данных, если он написал впервые,
    // и просто обновление столбца сообщений, если пользователь уже существует
